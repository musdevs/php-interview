...
### Мультикурсор с помощью клавиатуры

1. Выделить строки
2. Alt+Shift+Insert

### Мультикурсор с помощью мышки

Alt+Left click

## Базы данных

Поместить курсор на название таблицы и нажать Ctrl+Q - появиться окно с описанием структуры таблицы
