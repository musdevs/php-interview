...
## Мини-интервью Битрикс-разработчика

### Про прошлые работы
Почему уходишь из компании? Сколько в команде?
Как в компании устроен процесс разработки и деплоя?
Какие метрики качества кода используются (Code Review, статические анализаторы, покрытие тестами)?
С какими самыми сложными задачами сталкивались в последнее время, в прошлом?

### Про грейд
Знакомы с курсом Разработчик Bitrix Framework?
Понимаете разницу в уровнях Junior, Middle и Senior
Какой уровень?

### PHP
Какие свойства и методы можно объявить в интерфейсе?
Что такое позднее статическое свзывание? Для чего нужен ключевое слово static? В чем разница между self, static и parent?
Чем отличается замыкание от стрелочной функции?
Какие преимущества у генераторов?

### Битрикс
Какие модули знаете лучше и хуже всего?
В каком каталоге вы создадите новый компонент и из каких файлов он будет состоять?
Как сделать отчет по сделке в формате Word?
Какие типы пользовательских полей можно создавать в задаче?

### Devops
Как подключиться к запущенному контейнеру и посмотреть содержимое каталога /etc в древовидном виде?
Как посмотреть список таблиц в определенной БД из консоли MySQL
