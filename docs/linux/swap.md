...
### [Swaptop](https://github.com/luis-ota/swaptop)

Монитор использования подкачки в реальном времени для систем Linux и Windows
с интерфейсом TUI. Выводит список процессов, использующих подкачку,
отображает потребление по каждому процессу/программе и предоставляет
